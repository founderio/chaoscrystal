...
public class Config {
	...
	{
		cfgForceBiome = config.getBoolean("force_biome", Configuration.CATEGORY_GENERAL, false, "");
		...
		cfgBiomeId = config.getInt("biomes_id", Configuration.CATEGORY_GENERAL, 68, 0, 255, "Id of the Crystal Beach Biome");
		cfgCrystalAspectStorage = config.getInt("crystal_aspect", Configuration.CATEGORY_GENERAL, 1000000, 10 , 1000000000, "");
		cfgHitsPerTick = config.getInt("hits_per_tick", Configuration.CATEGORY_GENERAL, 1, 1, 10000000, "");
